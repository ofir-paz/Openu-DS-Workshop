...
class SpineCNN(BaseModel):
    ...
    def __init__(self, image_height: int, image_width: int, depth=32):
        ...
        self.conv1 = nn.Conv3d(in_channels=depth, out_channels=16, kernel_size=(3, 3, 3), padding=1)
        ...
        self.conv3 = nn.Conv3d(in_channels=32, out_channels=depth, kernel_size=(3, 3, 3), padding=1)
        ...
        self.fc1 = nn.Linear(conv_output_depth * conv_output_height * conv_output_width, self.num_conditions * 3)
